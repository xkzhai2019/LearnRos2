...
class Download{
    public:
        void download(const std::string &host, const std::string &path,std::function<void(const std::string &,const std::string &)> &callback){
...
int main(){
    ...
    download1.start_download("http://localhost:8000","/novel1.txt",download_finish_callback);
    download1.start_download("http://localhost:8000","/novel2.txt",download_finish_callback);
    download1.start_download("http://localhost:8000","/novel3.txt",download_finish_callback);
